...
public actual class ToolBar(toolBarPtr: CPointer<GtkToolbar>? = null) : Container, ToolShell {
    ...
    public actual fun fetchItemIndex(item: ToolItemBase): Int = gtk_toolbar_get_item_index(gtkToolBarPtr, item.gtkToolItemPtr)
    ...
    public actual fun fetchDropIndex(x: Int, y: Int): Int = gtk_toolbar_get_drop_index(toolbar = gtkToolBarPtr, x = x, y = y)
