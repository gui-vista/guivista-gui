...
public actual interface MenuItemBase : Container {
     ...
     * @param userData User data to pass through to the [slot].
     */
    public fun connectActivateItemSignal(slot: CPointer<ActivateItemSlot>, userData: gpointer): ULong =
     ...
     * @param userData User data to pass through to the [slot].
     */
    public fun connectDeselectSignal(slot: CPointer<DeselectSlot>, userData: gpointer): ULong =
     ...
     * @param userData User data to pass through to the [slot].
     */
    public fun connectSelectSignal(slot: CPointer<SelectSlot>, userData: gpointer): ULong =
