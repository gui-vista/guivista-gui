...
public actual class TextBuffer(textBufferPtr: CPointer<GtkTextBuffer>? = null) : ObjectBase {
    ...
    override fun disconnectSignal(handlerId: ULong) {
        ...
        disconnectGSignal(gtkTextBufferPtr, handlerId)
    }
    ...
    public fun connectBeginUserActionEvent(handler: CPointer<BeginUserActionHandler>, userData: gpointer): ULong =
        connectGSignal(obj = gtkTextBufferPtr, signal = TextBufferEvent.beginUserAction, slot = handler,
            data = userData)
    ...
    public fun connectEndUserActionEvent(handler: CPointer<EndUserActionHandler>, userData: gpointer): ULong =
        connectGSignal(obj = gtkTextBufferPtr, signal = TextBufferEvent.endUserAction, slot = handler, data = userData)
    ...
    public fun connectChangedEvent(handler: CPointer<ChangedHandler>, userData: gpointer): ULong =
        connectGSignal(obj = gtkTextBufferPtr, signal = TextBufferEvent.changed, slot = handler, data = userData)
    ...
    public fun connectModifiedChangedEvent(handler: CPointer<ModifiedChangedHandler>, userData: gpointer): ULong =
        connectGSignal(obj = gtkTextBufferPtr, signal = TextBufferEvent.modifiedChanged, slot = handler, data = userData)
    ...
    public fun connectDeleteRangeEvent(handler: CPointer<DeleteRangeHandler>, userData: gpointer): ULong =
        connectGSignal(obj = gtkTextBufferPtr, signal = TextBufferEvent.deleteRange, slot = handler, data = userData)

    /**
     * Connects the *insert-text* event to a [handler] on a [TextBuffer]. This event is triggered when inserting text
     * in a [TextBuffer]. Insertion actually occurs in the default handler. Note that if your handler runs before the
    ...
    public fun connectInsertTextEvent(handler: CPointer<InsertTextHandler>, userData: gpointer): ULong =
        connectGSignal(obj = gtkTextBufferPtr, signal = TextBufferEvent.insertText, slot = handler, data = userData)
}
