package org.gui_vista.core.widget.tool

import gtk3.*
import kotlinx.cinterop.CPointer
import org.gui_vista.core.ObjectBase
...
interface ToolShell : ObjectBase {
     ...
     * [ToolItem's][org.gui_vista.core.widget.tool.item.ToolItem]
     * [iconSize][org.gui_vista.core.widget.tool.item.ToolItem.iconSize] property instead.
     */
     ...
     * on [ToolItem's][org.gui_vista.core.widget.tool.item.ToolItem]
     * [orientation][org.gui_vista.core.widget.tool.item.ToolItem.orientation] property instead.
     */
     ...
     * [ToolItem's][org.gui_vista.core.widget.tool.item.ToolItem]
     * [reliefStyle][org.gui_vista.core.widget.tool.item.ToolItem.reliefStyle] property instead.
     */
     ...
     * rely on [ToolItem's][org.gui_vista.core.widget.tool.item.ToolItem]
     * [toolbarStyle][org.gui_vista.core.widget.tool.item.ToolItem.toolBarStyle] property instead.
     */
     ...
     * rely on [ToolItem's][org.gui_vista.core.widget.tool.item.ToolItem]
     * [textAlignment][org.gui_vista.core.widget.tool.item.ToolItem.textAlignment] property instead.
     */
     ...
     * rely on [ToolItem's][org.gui_vista.core.widget.tool.item.ToolItem]
     * [textOrientation][org.gui_vista.core.widget.tool.item.ToolItem.textOrientation] property instead.
     */
     ...
     * rely on [ToolItem's][org.gui_vista.core.widget.tool.item.ToolItem]
     * [textSizeGroup][org.gui_vista.core.widget.tool.item.ToolItem.textSizeGroup] property instead.
     */
     ...
     * [ToolItem's][org.gui_vista.core.widget.tool.item.ToolItem]
     * [rebuildMenu][org.gui_vista.core.widget.tool.item.ToolItem.rebuildMenu] function instead.
     */
    fun rebuildMenu() {
