...
interface ToolItemBase : Container {
     ...
     * @see [org.gui_vista.core.widget.button.Button.relief]
     */
    ...
    /**
     * Whether the toolbar item is visible when the [ToolBar][org.gui_vista.core.widget.tool.ToolBar] is in a horizontal
    ...
    /**
     * Whether the toolbar item is visible when the [ToolBar][org.gui_vista.core.widget.tool.ToolBar] is in a vertical
     * orientation. Default value is *true*.
     */
     ...
     * [ToolBar][org.gui_vista.core.widget.tool.ToolBar] then needed for the items. The effect is that the item gets
     * bigger when the [ToolBar][org.gui_vista.core.widget.tool.ToolBar] gets bigger, and smaller when the
     * [ToolBar][org.gui_vista.core.widget.tool.ToolBar] gets smaller.
     */
    var expand: Boolean
