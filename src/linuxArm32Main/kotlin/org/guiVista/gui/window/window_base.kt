...
actual interface WindowBase : Container {
     ...
     */
    fun connectActivateDefaultSignal(slot: CPointer<ActivateDefaultSlot>, userData: gpointer): UInt =
     ...
     * @param userData User data to pass through to the [slot].
     */
    fun connectActivateFocusSignal(slot: CPointer<ActivateFocusSlot>, userData: gpointer): UInt =
     ...
     * @param userData User data to pass through to the [slot].
     */
    fun connectEnableDebuggingSignal(slot: CPointer<EnableDebuggingSlot>, userData: gpointer): UInt =
     ...
     * @param userData User data to pass through to the [slot].
     */
    fun connectKeysChangedSignal(slot: CPointer<KeysChangedSlot>, userData: gpointer): UInt =
     ...
     * @param userData User data to pass through to the [slot].
     */
    fun connectSetFocusSignal(slot: CPointer<SetFocusSlot>, userData: gpointer): UInt =
