...
actual interface Range : WidgetBase {
     ...
     */
    fun connectAdjustBoundsSignal(slot: CPointer<AdjustBoundsSlot>, userData: gpointer): UInt =
     ...
     * @param userData User data to pass through to the [slot].
     */
    fun connectMoveSliderSignal(slot: CPointer<MoveSliderSlot>, userData: gpointer): UInt =
