...
public actual interface Range : WidgetBase {
     ...
     */
    public fun connectAdjustBoundsSignal(slot: CPointer<AdjustBoundsSlot>, userData: gpointer): UInt =
     ...
     * @param userData User data to pass through to the [slot].
     */
    public fun connectMoveSliderSignal(slot: CPointer<MoveSliderSlot>, userData: gpointer): UInt =
    ...
    override fun disconnectSignal(handlerId: ULong) {
        ...
        disconnectGSignal(gtkRangePtr, handlerId.toUInt())
    }
}
 ...
 * 3. userData: gpointer
 */
public typealias MoveSliderSlot =
