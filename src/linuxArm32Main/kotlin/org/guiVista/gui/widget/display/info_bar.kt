...
actual class InfoBar(infoBarPtr: CPointer<GtkInfoBar>? = null) : Container {
    ...
    actual var showCloseButton: Boolean
    ...
    actual fun addMultipleButtons(vararg buttons: Pair<Int, String>) {
        buttons.forEach { (responseId, txt) -> addButton(txt, responseId) }
    }

    actual fun response(responseId: Int) {
