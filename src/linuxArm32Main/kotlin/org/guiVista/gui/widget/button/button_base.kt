...
public actual interface ButtonBase : Container, Actionable {
    ...
    public fun connectClickedEvent(handler: CPointer<ClickedHandler>, userData: gpointer): ULong =
        connectGSignal(obj = gtkButtonPtr, signal = ButtonBaseEvent.clicked, slot = handler, data = userData).toULong()
    ...
    public fun connectActivateEvent(handler: CPointer<ActivateHandler>, userData: gpointer): ULong =
        connectGSignal(obj = gtkButtonPtr, signal = ButtonBaseEvent.activate, slot = handler, data = userData).toULong()
