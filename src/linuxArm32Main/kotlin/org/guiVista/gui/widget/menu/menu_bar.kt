...
public actual class MenuBar(menuBarPtr: CPointer<GtkMenuBar>? = null) : MenuShell {
...
public fun menuBarWidget(menuBarPtr: CPointer<GtkMenuBar>? = null, init: MenuBar.() -> Unit): MenuBar {
