...
public actual class MenuItem private constructor(menuItemPtr: CPointer<GtkMenuItem>?) : MenuItemBase {
    override val gtkWidgetPtr: CPointer<GtkWidget>? = menuItemPtr?.reinterpret()
